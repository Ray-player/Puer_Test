...
3. 源码不包含V8虚拟机内核，请在[Releases](https://github.com/Ray-player/Puer_Test/releases/tag/V8ThirdParty)中下载或前往[Puerts官方文档](https://puerts.github.io/docs/puerts/unreal/install)下载对应内核。
